...
{
    /// <summary>
    /// Controls how many Kafka consumers Irkalla.Kafka runs per request topic.
    /// </summary>
    public enum ConsumerMode
    {
        ...
        /// <summary>
        /// Auto-scale consumers per topic. Irkalla.Kafka starts several consumers in the same
        /// consumer group for a topic — up to the topic's partition count (optionally capped by
        /// <see cref="IrkallaKafkaOptions.MaxConsumersPerTopic"/>). Kafka's group protocol spreads
