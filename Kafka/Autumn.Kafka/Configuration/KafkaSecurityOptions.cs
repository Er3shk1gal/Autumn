...
namespace Autumn.Kafka.Configuration
{
    ...
    /// (Confluent.Kafka) — Autumn.Kafka only forwards these settings. Anything not surfaced here
    /// can still be set via <see cref="AutumnKafkaOptions.RawConfig"/> (raw key/value) or the
