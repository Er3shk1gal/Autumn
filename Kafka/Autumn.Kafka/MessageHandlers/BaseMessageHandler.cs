...
namespace Autumn.Kafka.MessageHandlers
{
        ...
        : IDisposable
    {
        ...
        protected readonly Autumn.Kafka.Configuration.AutumnKafkaOptions Options = options;

        private static readonly ActivitySource ActivitySource = new("Autumn.Kafka");
        private static readonly Meter Meter = new("Autumn.Kafka");
